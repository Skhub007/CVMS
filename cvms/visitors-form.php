...
$reasontomeet=$_POST['reasontomeet'];
 $query=mysqli_query($con,"insert into tblvisitor(companyname,FullName,Email,MobileNumber,Address,WhomtoMeet,Deptartment,ReasontoMeet) value('$companyname','$fullname','$email','$mobnumber','$add','$whomtomeet','$department','$reasontomeet')");
